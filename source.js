// ==UserScript==
// @name         TETR.IO翻译-自用版
// @namespace    https://github.com/Galcatqwq/iotranslate
// @version      2.4.2
// @match        https://*.tetr.io/*
...
(() => {
    ...
    const textMap = {
        ...
        DESKTOP: "桌面客户端",
        GET: "获取",
        "puzzle together in this modern yet familiar online stacker. play against friends and foes all over the world, or claim a spot on the leaderboards - the stacker future is yours!": "欢迎挑战这款ZUN新最热现代方块.与世界各地的好友和对手对战,在排行榜上占据一席之地——方块的未来在您手中!",
        ...
        "the nickname": "这个昵称",
        "hasn't been registered. do you want to claim it as yours, or play anonymously? you won't be able to submit scores to the leaderboards or play in matchmaking when anonymous.": "没有被注册.请问你是想把它作为你的账号,还是进行匿名挑战?匿名时,你将无法向排行榜提交分数或参加比赛.",
        "stay ANONYMOUS": "保持匿名",
        REGISTER: "注册",
        ...
        "NEW GAMEMODE!!": "全新模式!!",
        "leaderboards, achievements, replays and more": "排行榜,成就,往昔重现",
        "NEW!": "更新!",
        ...
        NEXT: "继续",
        "play more games to receive a rank": "发起更多挑战以获得段位",
        "Off-season": "淡季",
        "OFF-SEASON": "淡季",
        UNRANKED: "无排名",
        "MATCH SUSPENDED": "战局暂停",
        ...
        "started the game": "开始挑战",
        "aborted the game": "终止挑战",
        "ZEN WHILE WAITING": "赛前热身",
        "BACK TO ROOM": "回到房间",
        SPECTATING: "旁观中",
        "CURRENTLY INGAME": "正在试炼中",
        "game finished": "试炼结束",
        "welcome to": "欢迎来到",
        "is a free familiar yet fast-paced online stacker in the same genre as tetris, and played by millions across the globe.": "是一款免费、易上手且快节奏的在线堆叠试炼场,方式与俄罗斯方块类似,在全球范围内拥有数百万挑战者.",
        ...
        "you can change these and many other settings in CONFIG. have fun!": "您可以在设置中更改这些和许多其他设置.祝您享受愉快!",
        ...
        "PLAYERS (": "挑战者(",
        "welcome to the ZENITH TOWER! send lines and KO enemies to scale the tower.": "欢迎来到天顶之塔!发送垃圾行偷袭敌人即可逐渐飞跃高塔",
        "the further up the tower, the stronger the opponents!": "越往上飞,对手越恐怖!",
        "leaderboards reset every week, how far can you get?": "排行榜每周重置,你能飞多高?",
        "LEADERBOARD CYCLES IN":"排行榜更新时间:",
        "ADD OR REMOVE MODS": "添加或移除模组",
        "YOUR FINAL ALTITUDE": "飞行曲线顶点",
        "THIS WEEK'S PERSONAL RANK": "本周个人排名",
        "this is your first game this week, play more to track your improvement": "这是你本周的第一场对局,多多挑战以跟踪你的进步",
        ...
        "ATTACK":"轰炸当量",
        "VERSUS SCORE":"平均轰炸烈度",
        "LINES RECEIVED":"接收垃圾行",
        "SINGLES":"单消",
        "DOUBLES":"双消",
        "TRIPLES":"三消",
        "QUADS":"四消",
        "SPIN MINI ZEROES":"迷你旋转零消",
        "SPIN ZEROES":"旋转零消",
        "SPIN MINI SINGLES":"迷你旋转单消",
        "SPIN SINGLES":"旋转单消",
        "SPIN MINI DOUBLES":"迷你旋转双消",
        "SPIN DOUBLES":"旋转双消",
        "SPIN MINI TRIPLES":"迷你旋转三消",
        "SPIN TRIPLES":"旋转三消",
        "SPIN MINI QUADS":"迷你旋转四消",
        "SPIN QUADS":"旋转四消",
        "T-spins":"T旋",
        "T-spin ZEROES":"T旋零消",
        "T-spin MINIS":"迷你T旋",
        "T-spin MINI SINGLES":"迷你T旋单消",
        "T-spin SINGLES":"T旋单消",
        "T-spin MINI DOUBLES":"迷你T旋双消",
        "T-spin DOUBLES":"T旋双消",
        "T-spin MINI TRIPLES":"迷你T旋三消",
        "T-spin TRIPLES":"T旋三消",
        ...
        "rotation system used in arcade games": "在街机平台中使用的旋转系统.",
        ...
        //房间列表相关文本
        "ROOM LISTING": "房间列表",
        "face off against the best in a single lobby shared by all!": "加油,特种兵!",
        ROYALE: "绝地求生",
        ...
        "expert quick play": "王的测试飞行",
        "career best": "巅峰记录",
        "Career best:": "巅峰记录:",
        "ago • Career best:": "前 • 巅峰记录:",
        "leaderboards, replays and more": "排行榜、往昔重现等",
        ...
        "maximum COMBO": "最高连击数",
        "maximum back-to-back chain": "最高back-to-back连锁",
        "finesse %": "极简率",
        "finesse faults": "非极简操作",
        "FINAL TIME": "最终时间",
        "FINAL SCORE": "最终得分",
        RESULTS: "比赛结果",
        "got a new personal best in 40 LINES with a time of": "在追逐40光秒中取得了新的个人最好成绩,时间为",
        "got a new personal best in BLITZ with a score of": "在闪击波兰中取得了新的个人最好成绩,得分为",
        "has become a": "成为了",
        ...
        SCORES: "分数",
        "LATEST NEWS": "最新动态",
        "VIEW TETRA LEAGUE RECORD": "查看中门对狙往昔重现",
        "VIEW PERSONAL BEST": "查看最好成绩",
        "VIEW ALL 40 LINES RECORDS": "查看全部的追逐40光秒往昔重现",
        Achieved: "达成于",
        months: "月",
        ago: "前",
        "VIEW ALL BLITZ RECORDS": "查看全部的闪击波兰往昔重现",
        "VIEW ALL RECENT RECORDS": "查看全部的近期往昔重现",
        RECORD: "往昔重现",
        VIEW: "查看",
        "PLAY TIME": "试炼时长",
        "ONLINE GAMES": "试炼场次",
        ...
        "Clear 40 LINES using only T-Spin Doubles": "仅限使用T-Spin Double完成追逐40光秒",
        "The ancient tradition of six pieces, all placed to serve the needs of one.": "传统的方块六件套,只为最完美的T块而堆.",
        SPRINTER: "追逐40光秒爱好者",
        "40 LINES games completed": "追逐40光秒次数",
        "Don't reset.": "永不重开!",
        "SNAKE EYES": "蛇眼",
        "Clear 40 LINES using only Singles": "仅限使用单消完成追逐40光秒",
        "Death by exactly 40 cuts.": "正好四十次.",
        "1-8 STACKING": "一八堆叠王",
        "Clear 40 LINES using 10 Quads in column 2 or 9": "仅限在第二列或第九列中使用十个消四完成追逐40光秒",
        "Don't waste the I-Piece!": "我从不浪费I块.",
        "MR. BOARDWIDE": "版面天王",
        "Clear 40 LINES using a Quad in each of the 10 columns": "在每一列中都完成一次消四完成追逐40光秒",
        "Master of all columns.": "万列归宗!",
        "Clear 40 LINES using only All Clears": "仅限使用10个全清完成追逐40光秒",
        "To clear without waste is to express the highest form of gratitude.": "一块也不浪费才是对方块的最崇高的敬意.",
        BLITZER: "闪击波兰爱好者",
        "points earned in completed BLITZ games": "完成闪击波兰挑战获得的分数总和",
        "Two minutes of perfection.": "完美的两分钟.",
        "WABI-SABI": "侘寂",
        "highest BLITZ score obtained without performing any All Clears": "不使用任何全消的情况下获得的最高闪击波兰分数",
        "Two minutes of imperfection.": "不完美的两分钟.",
        "NAGA EYES":"纳迦眼",
        "Clear 40 LINES using 40 Spin Singles":"仅限使用40次旋转消一完成追逐40光秒",
        ...
        "Uncover the mysteries of the Zenith Tower.": "探索天顶之塔的秘密.",
        "THE LOVERS": "恋人",
        'highest floor discovered with the "DUO" mod': "在恋情中抵达的最高层数",
        "Love, and resign yourself to the fate of another.": "去爱,去把握命中注定的缘分.",
        "TOWER CLIMBER": "飞行爱好者",
        "meters climbed": "飞跃的海拔高度",
        '"Have I been here before..?"': "“这给我飞哪来了...?”",
        "THE EMPEROR": "皇帝",
        'highest floor discovered with the "Expert Mode" mod': "在启用“王”模组的情况下抵达的最高层数",
        "A display of power for those willing to bear its burden.": "欲戴王冠,必承其重.",
        "WHATEVER IT TAKES": "不计代价",
        "players KO'd in Quick Play": "在测试飞行中击落的挑战者数",
        "Mere sacrifices in the pursuit of greatness...": "一将功成万骨枯...",
        "THE RESPONSIBLE ONE": "责任神",
        "highest amount of revivals performed in a single DUO run": "在一次恋情中完成的最多复活次数",
        '"Could you please stop dying?"': "杂鱼~能不能少死点?",
        STRENGTH: "力量",
        ...
        TEMPERANCE: "节制",
        'highest floor discovered with the "No Hold" mod': "在启用“节制”模组的情况下抵达的最高层数",
        ...
        "A MODERN CLASSIC": "现代经典",
        'highest floor discovered while using the "No Hold" and "Gravity" mods': "在启用“节制”和“重力”模组的情况下抵达的最高层数",
        ...
        "TRAINED PROFESSIONALS": "专业团队",
        'highest floor discovered in a DUO while both players are using the "Expert Mode" mod': "在启用“恋情”模组且双方均启用“王”模组的情况下抵达的最高层数",
        ...
        "Clear 40 LINES using as few inputs as possible": "使用尽可能少的输入追逐40光秒",
        ...
        SUPERCHARGED: "浪涌增压",
        "highest Back-to-Back chain reached in Quick Play without any mods": "在不启用任何模组的测试飞行中达到的最高Back-to-Back连锁数",
        ...
        "THE STARVING ARTIST": "绝处逢生",
        'highest floor discovered while using the "No Hold" and "All-Spin" mods': "在启用““节制”和“ALL-Spin”模组的情况下抵达的最高层数",
        "Creativity cultivated through limitation.": "在逆境中成长的创造力.",
        "GUARDIAN ANGEL": "守护天使",
        "highest altitude to perform a successful revive at": "完成守护的顶端海拔高度",
        "An angel's intervention.": "天使下凡.",
        "THE CON ARTIST": "瞒天过海",
        'highest floor discovered while using the "Expert Mode", "Volatile Garbage" and "All-Spin" mods': "在启用“王”,“达摩克利斯之剑”和“ALL-Spin”模组的情况下抵达的最高层数",
        ...
        "highest BLITZ score obtained without using Hold": "在不使用暂存的情况下完成闪击波兰挑战获得的最高分数",
        "THE TYRANT": "暴君",
        'highest floor discovered with the reversed "Expert Mode" mod': "在启用逆位“王”模组的情况下抵达的最高层数",
        "Fear, oppression, and limitless ambition.": "恐惧、压迫,以及无限的野心.",
        "fear, oppression, and limitless ambition": "恐惧、压迫,以及无限的野心",
        ASCETICISM: "禁欲",
        'highest floor discovered with the reversed "No Hold" mod': "在启用逆位“节制”模组的情况下抵达的最高层数",
        ...
        COMPETITIVE: "竞争性",
        "This achievement grants extra Achievement Rating to those who place in its Top 100 leaderboard.": "此成就给进入前100的挑战者提供额外的AR.",
        HIDDEN: "隐藏",
        ...
        CHEATING: "作弊",
        "including, but not limited to cheating, botting, hacking or otherwise breaking the game or getting an unfair advantage.": "包括但不限于作弊、使用机器人、黑客手段或其他破坏智慧核心或获得不公平优势的行为.",
        ...
        "GO!": "开始!",
        "40 LINES": "追逐40光秒",
        "complete 40 lines as quickly as possible": "无限时间的速率挑战",
        "clear 40 lines in the shortest amount of time possible.": "以最短的时间内追逐40光秒",
        ...
        "play as you wish! replays are not submitted.": "尽情享受!往昔重现不会被记录",
        OBJECTIVE: "目标",
        ...
        "play for a set amount of time to clear": "在设定的时间内进行试炼并尽可能消除方块",
        "get to a set amount of garbage lines to clear": "达到设定的垃圾行消除数",
        TIMED: "计时模式",
        time: "时间",
        count: "计数",
        "topping out is OK": "允许顶出",
        "display objective behind board": "在面板后面显示目标",
        INTRO: "简介",
        mission: "任务",
        ...
        CONFIG: "设置",
        "tweak your":"调整你的",
        "tweak your <>TETRIO<> experience": "调整<>TETRIO<>体验",
        ...
        HIGH: "高",
        "[NOT SET]": "[未设置]",
        "hover over a setting for more info": "移动鼠标至设置名称上以查看详细说明",
        ...
        "do not animate background in super lobbies": "禁用绝地求生中滚动显示挑战者",
        "do not animate background in quick play": "禁用测试飞行中的背景动画",
        "no background in menus": "关闭菜单背景",
        "filter profanity in chat": "过滤聊天中的脏话",
        "hide chat when ingame": "试炼中隐藏聊天栏",
        ...
        "keep replay tools open": "一直显示往昔重现工具栏",
        ...
        "Anonymous accounts have no meaningful statistics and cannot save replays.":"匿名账号没有有意义的回忆,也无法保存往昔重现.",
        ...
        ABOUT: "关于",
        "all about":"关于",
        "thank you for playing": "感谢享受",
        //其他文本
        "pick a game mode": "选择试炼类型",
        ...
        "replay will not be saved": "不会有往昔重现",
        MANUAL: "手册",
        ...
        "Ending an": "正在结算一场",
        PROFILE: "个人资料",
        "Couldn't find anyone like that.": "找不到该挑战者",
        GIFT: "赠送",
        "- MUTUAL FRIENDS": " - 双向好友",
        ...
        "it seems WEBGL is disabled in your browser. WEBGL is required for the game to render properly.": "看来你的浏览器禁用了WEBGL.框架需要WEBGL才能正常渲染.",
        ...
        "GAME CANCELLED": "对局中止",
        "THIS GAME WAS CANCELLED BECAUSE A PLAYER HAS LEFT.YOUR RATING WILL NOT BE ADJUSTED.": "由于一名挑战者中途退出,此次战局已中止.你的评分不会受到调整.",
        //活动
        EVENT: "活动",
        LEGACY: "遗留",
        ...
        "LOVERS' PROMISE": "真爱之誓",
        "highest altitude reached with your TETR.IO Valentine": "和你的TETR.IO情人一起飞跃的顶端海拔高度",
        "The impossible promise of an eternity just like this moment.": "沧海桑田,此瞬永恒.",
        "BLEEDING HEARTS": "血心鉴誓",
        'highest floor discovered with the reversed "Duo" mod': "在启用逆位恋情的情况下抵达的最高层数",
        ...
        "A journey of one thousand six hundred fifty meters starts with a single step.": "1650m的旅程始于一小步.",
        ...
        "Listen to all the tracks from TETR.IO's Quick Play 2 gamemode in lossless quality, together with additional goodies like sheet music, a piano version and full stems!": "以无损音质聆听 TETR.IO 测试飞行 模式中的所有曲目,还有乐谱、钢琴版和完整音轨等其他好东西!",
    ...
    const tooltipMap = {
        ...
        "Change the way TETR.IO feels": "改变你享受TETR.IO的手感",
        ...
        "The standard controls, as seen in many stacker games.": "标准控制,在许多方块平台中都能看到.",
        ...
        "If enabled, the background music won't reset when you retry a game.": "如果启用,当你重启一场战局时,背景音乐不会重置.",
        "If enabled, no audio will ever play. This will speed up the game, with a rather obvious drawback.": "如果启用,将永远不会有音频播放.这将加快框架的运行速度,但有相当明显的缺点.",
        ...
        "If enabled, don't show as much precision on in-game counters. Speeds up the game significantly.": "如果启用,在面板的计数器上不会显示那么多精度.大大加快了框架的运行速度.",
        "If enabled, always shows the simpler thumbnails for other players. This increases performance in games between 2 and 10 players, but looks less nice.": "如果启用,总是显示其他挑战者的更简单的缩略图.这在2到10个挑战者之间的战局中提高了性能,但看起来不太美观.",
        "If enabled, the background of Super Lobbies (rooms of 100+players) does not animate (outside of the intro).": "如果启用,超级大厅（有100名以上挑战者的房间）的背景不会有动画（除了介绍之外）.",
        "If enabled, do not show the background when in menus. This will majorly improve performance in menus, but you will no longer see the background.": "如果启用,在菜单中不显示背景.这会极大地提高菜单的性能,但你不再会看到背景.",
        "If enabled, profanity in chat will be filtered. Note that such filters are never perfect.": "如果启用,聊天中的脏话会被过滤掉.请注意,这样的过滤器永远不会完美.",
        "If enabled, chat will be hidden when ingame.": "如果启用,聊天将在试炼中被隐藏.",
        "If enabled, room IDs will not be shown, to protect you from streamsniping.": "如果启用,不会显示房间ID,以保护你不被流媒体窃取.",
        ...
        "If enabled, the replay tools do not collapse when you're not using them.": "如果启用,当你不使用这些工具时,往昔重现工具栏不会关闭.",
        ...
        "If enabled, show notifications outside of the game.": "如果启用,显示框架外的通知.",
        "If enabled, unimportant notifications don't show ingame, but will be shown after the game.": "如果启用,不重要的通知不会在试炼中显示,但会在试炼后显示.",
        "If enabled, notification sounds always play at full volume.": "如果启用,通知声音总是以全音量播放.",
        "Don't notify me.": "不要通知我.",
        "Only notify me ingame.": "只有在框架中才会通知我.",
        "Notify me ingame and with a desktop notification.": "在框架中通知我,并以桌面通知的方式通知我.",
        ...
        "Show extra info and arrange some info for pro players.": "显示额外的信息,为专业挑战者显示一些信息.",
        "Alert me when I make a finesse fault.": "当我有非极简操作时提醒我.",
        "Restart the game when I make a finesse fault.": "当我有非极简操作时,重新开始挑战.",
        ...
        "The type of metric to display in the first left-hand slot.": "要在面板左侧第一个信息槽中显示的度量衡的类型.",
        "The type of metric to display in the second left-hand slot.": "要在面板左侧第二个信息槽中显示的度量衡的类型.",
        ...
        "This user is likely a plonker": "该挑战者倾向于使用反击策略",
        "This user is likely an opener main": "该挑战者倾向于使用开局策略",
        "This user is likely an infnite downstacker": "该挑战者倾向于使用挖掘策略",
        "This user is likely a strider": "该挑战者倾向于使用火力策略",
        "Amount of players who have friended this person": "有多少个挑战者将该挑战者添加为好友",
        ...
        "If enabled, always shows the simpler thumbnails for other players. This increases performance in games between 2 and 8 players, but looks less nice.": "如果启用,则始终显示其他挑战者更简单的缩略图.这可以提高在2到8名挑战者之间对局的性能,但看起来会不太好.",
        "If enabled, the background of Quick Play does not animate.": "如果启用,测试飞行的背景不会播放动画",
        "If enabled, the background of Super Lobbies (rooms of 100+ players) does not animate (outside of the intro).": "如果启用,绝地求生中的背景不会动画化（开始前除外）",
        ...
        "Maximum players in this room. 0 = no limit. Does not apply retroactively.": "房间最大挑战者数（0=无限制,不可追溯调整）",
        ...
        "Whether to allow users who are in a matchmaking queue to enter this room. Does not apply retroactively.": "是否允许匹配队列中的挑战者加入（不可追溯调整）",
        "Whether to allow unranked users to play in this room.": "是否允许无段位挑战者加入",
        ...
        "Background song to play. If random, not everyone will hear the same song.": "背景音乐设置（随机模式下挑战者听到的曲目可能不同）",
        "This achievement grants extra Achievement Rating to those who place in its Top 100 leaderboard.": "此成就给进入前100的挑战者提供额外的AR.",
        "This achievement is only visible to the worthy.": "此成就仅对值得的人可见.",
        "This achievement does not contribute to your Achievement Rating.": "此成就不予提供AR.",
    ...
    const specialTextMap = {
        ...
        "checking for game updates(.*)": "检查框架更新$1",
        "(.*) this session": "本次在线时间:$1",
        "(.*) ONLINE": "$1人在线",
        "([0-9]+)% towards next level": "离下一个等级还有$1%",
        "This user's winrate is not heavily affected if they lost their previous match. (.*)": "该挑战者的胜率可能不会因他上一场比赛的落败而产生较大影响.$1",
        "This user's winrate is not heavily affected if they won their previous match. (.*)": "该挑战者的胜率可能不会因他上一场比赛的获胜而产生较大影响.$1",
        "This user tends to continue losing if they lost their previous match. (.*)": "该挑战者的胜率可能会因他上一场比赛的落败而降低.$1",
        "This user tends to continue winning if they won their previous match (.*)": "该挑战者的胜率可能会因他上一场比赛的获胜而提高.$1",
        "This user tends to win if they lost their previous match. (.*)": "该挑战者的胜率可能会因他上一场比赛的落败而提高.$1",
        "This user tends to lose if they won their previous match. (.*)": "该挑战者的胜率可能会因他上一场比赛的获胜而降低.$1",
        "This user has a high winrate against openers. (.*)": "该挑战者对开局策略有很高的胜率.$1",
        "This user has a high winrate against striders. (.*)": "该挑战者对火力策略有很高的胜率.$1",
        "This user has a high winrate against inf ds'ers. (.*)": "该挑战者对挖掘策略有很高的胜率.$1",
        "This user has a high winrate against plonkers. (.*)": "该挑战者对反击策略有很高的胜率.$1",
        "This user has a low winrate against openers. (.*)": "该挑战者对开局策略有很低的胜率.$1",
        "This user has a low winrate against striders. (.*)": "该挑战者对火力策略有很低的胜率.$1",
        "This user has a low winrate against inf ds'ers. (.*)": "该挑战者对挖掘策略有很低的胜率.$1",
        "This user has a low winrate against plonkers. (.*)": "该挑战者对反击策略有很低的胜率.$1",
        "This user has a high average VS compared to other players (.*)": "该挑战者的VS高于平均水平 $1",
        "This user has a high average APM compared to other players (.*)": "该挑战者的APM高于平均水平 $1",
        "This user has a high average PPS compared to other players (.*)": "该挑战者的PPS高于平均水平 $1",
        "This user has a low average VS compared to other players (.*)": "该挑战者的VS低于平均水平 $1",
        "This user has a low average APM compared to other players (.*)": "该挑战者的APM低于平均水平 $1",
        "This user has a low average PPS compared to other players (.*)": "该挑战者的PPS低于平均水平 $1",
        "Bottled Snowman(.*)": "瓶装雪人$1",
        "(.*)The remains of a once great snowman...(.*)": "$1曾经是个大雪人$1",
        "(.*)Badge awarded to those with a Bronze rank 'Rolling The Snowman' achievement.": "该徽章颁发给在“滚动的雪雪弗斯”成就中达到青铜级成就的挑战者",
        "(.*)Badge awarded to those with a Silver rank 'Rolling The Snowman' achievement.": "该徽章颁发给在“滚动的雪雪弗斯”成就中达到白银级成就的挑战者",
        "(.*)Badge awarded to those with a Gold rank 'Rolling The Snowman' achievement.": "该徽章颁发给在“滚动的雪雪弗斯”成就中达到黄金级成就的挑战者",
        "(.*)Badge awarded to those with a Platinum rank 'Rolling The Snowman' achievement.": "该徽章颁发给在“滚动的雪雪弗斯”成就中达到铂金级成就的挑战者",
        "(.*)Badge awarded to those with a Diamond rank 'Rolling The Snowman' achievement.": "该徽章颁发给在“滚动的雪雪弗斯”成就中达到钻石级成就的挑战者",
        "(.*)Badge awarded to those with a top-10 placement in the 'Rolling The Snowman' achievement.": "该徽章颁发给在“滚动的雪雪弗斯”成就中排名前十的挑战者",
    ...
    const placeholderMap = {
        ...
        "enter replay id, url or username and hit enter...": "输入往昔重现碎片名、网址或用户名并按回车键……",
