...
(() => {
    ...
    const textMap = {
        ...
        "if you leave the game early at any point, you must rejoin immediately or you will be penalized. go conquer the ranks!": "如果您在对局中的任何时候提前逃离,必须立刻重新进入战局,否则将受到惩罚.去挑战排行榜上的其他对手吧!",
        LEADERBOARDS: "排行榜",
        ...
        EDIT: "编辑",
        "you just joined QUICK PLAY - you will play in the next game in this lobby. please wait for the current game to finish. feel free to spectate or play ZEN while waiting!": "您加入了测试飞行 - 请等待结束然后加入下一局.在等待时,您可以选择旁观或游玩单人的禅意模式!",
        ...
        LEADERBOARDS: "排行榜",
        "GLOBAL LEADERBOARDS FOR 40 LINES AND BLITZ": "40行竞速和巅峰记录的全球排行榜",
        ME: "我的",
        ...
        EXPAND: "展开",
        "GLOBAL LEADERBOARDS FOR 40 LINES, BLITZ AND QUICK PLAY": "关于40行竞速,闪击波兰和测试飞行的全球排行榜",
        ...
        "Clear 40 LINES using only All Clears": "仅限使用10个全清完成40行挑战",
        ...
        "fetching TETRA LEAGUE data…": "获取联赛数据中···",
        "joining room…": "加入房间中···",
        "leaving room…": "离开房间中···",
        "creating room…": "创建房间中···",
        ...
        "show # of online games played on my profile": "在我的个人资料中显示所玩的总联赛战局数",
        ...
        'e.g. "Playing 40 LINES", "In TETRA LEAGUE queue", "In Menus"': "例如:“正在进行40行竞速”、“正在挑战联赛”、“在主菜单中“",
        ...
        "LOVERS' PROMISE": "真爱之誓",
        "highest altitude reached with your TETR.IO Valentine": "和你的TETR.IO情人一起飞跃的最高米数",
